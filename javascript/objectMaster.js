...
// const bListPkmn = pokémon.filter( p => p.name[0] === "E" );
// console.log(bListPkmn);
// console.log(pokémon[0].name[0]);

// const pkmnIds = pokémon.map( p => p.id )
// console.log(pkmnIds);

// const idDiv3Pkmn = pokémon.filter( p => p.id % 3 === 0 );
...
// const idGreaterThan99Pkmn = pokémon.filter( p => p.id > 99 ).map(p => p.name);
// console.log(idGreaterThan99Pkmn);

// const poisonPkmn = pokémon.filter( p => p.types[0] === "poison" || p.types[1]  === "poison" ).map(p => p.name);
// console.log(poisonPkmn);

// const flyingPkmn = pokémon.filter( p => p.types.length > 1 & p.types[1] === "flying").map(p => p.types[0]);
// console.log(flyingPkmn);

// const normalPkmn = pokémon.filter( p => p.types[0] === "normal" ).map(p => p.name);
